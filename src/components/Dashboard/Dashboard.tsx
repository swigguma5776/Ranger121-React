       ...
       <Box sx={{ display: 'flex'}}>
        ...
        >
            <Toolbar sx={ myStyles.toolbar }>
                ...
                <Button onClick={ handleDialogOpen } sx={ myStyles.toolbarButton }> Create a Drone </Button>
                {/* Create Drone Dialog Popup */}
                <Dialog open={ dialogOpen } onClose={ handleDialogClose } aria-labelledby='form-dialog-title'>
                    <DialogTitle id='form-dialog-title'>Add New Drone</DialogTitle>
                    <DialogContent>
                        <DialogContentText> Enter Drone Info Here (づ￣ 3￣)づ </DialogContentText>
                        <DroneForm /> 
                    </DialogContent>
                    <DialogActions>
        ...
        <Box sx={ myStyles.content } >
            <Box sx={ myStyles.drawerHeader} />
            <Typography variant='h6'>Hello World Until Data Shows Up</Typography>
            <DataTable />
        </Box>
       </Box>
    )
